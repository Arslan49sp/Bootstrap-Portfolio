...
This is personal portfolio. It is fully responsive on different devices.
...
- [Live Demo Link](https://arslan49sp.github.io/Bootstrap-Portfolio/)
...
Flollow these steps to get a local copy of this portfolio.
...
```sh
  git clone git@github.com:Arslan49sp/PortfolioMicro.git
```
